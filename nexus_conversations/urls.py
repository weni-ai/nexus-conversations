...
from conversation_ms.views import ConversationViewSet, SubTopicsViewSet, TopicsViewSet
...
urlpatterns = [
    ...
    path(
        "api/v1/projects/<uuid:project_uuid>/topics/",
        TopicsViewSet.as_view({"get": "list", "post": "create"}),
        name="topics",
    ),
    path(
