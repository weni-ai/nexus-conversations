...
# S3 conversation CSV export (presigned download for frontend)
AWS_S3_BUCKET_NAME = env.str("AWS_S3_BUCKET_NAME", default="")
AWS_S3_REGION_NAME = env.str("AWS_S3_REGION_NAME", default="us-east-1")
CONVERSATION_EXPORT_S3_PREFIX = env.str("CONVERSATION_EXPORT_S3_PREFIX", default="exports/conversations")
CONVERSATION_EXPORT_PRESIGNED_EXPIRY = env.int("CONVERSATION_EXPORT_PRESIGNED_EXPIRY", default=3600)
CONVERSATION_EXPORT_ITERATOR_CHUNK_SIZE = env.int("CONVERSATION_EXPORT_ITERATOR_CHUNK_SIZE", default=500)
CONVERSATION_EXPORT_TASK_TIMEOUT = env.int("CONVERSATION_EXPORT_TASK_TIMEOUT", default=900)
CONVERSATION_EXPORT_CELERY_SOFT_TIME_LIMIT = env.int("CONVERSATION_EXPORT_CELERY_SOFT_TIME_LIMIT", default=880)
CONVERSATION_EXPORT_CELERY_TIME_LIMIT = env.int("CONVERSATION_EXPORT_CELERY_TIME_LIMIT", default=960)
CONVERSATION_EXPORT_VIA_CELERY = env.bool("CONVERSATION_EXPORT_VIA_CELERY", default=True)
