...
# S3 archive pipeline
CONVERSATION_ARCHIVE_ENABLED = env.bool("CONVERSATION_ARCHIVE_ENABLED", default=False)
CONVERSATION_ARCHIVE_DRY_RUN = env.bool("CONVERSATION_ARCHIVE_DRY_RUN", default=True)
CONVERSATION_ARCHIVE_S3_BUCKET = env.str("CONVERSATION_ARCHIVE_S3_BUCKET", default="")
CONVERSATION_ARCHIVE_S3_PREFIX = env.str("CONVERSATION_ARCHIVE_S3_PREFIX", default="conversations-archive")
CONVERSATION_ARCHIVE_S3_REGION = env.str("CONVERSATION_ARCHIVE_S3_REGION", default="")
CONVERSATION_ARCHIVE_LOCK_ENABLED = env.bool("CONVERSATION_ARCHIVE_LOCK_ENABLED", default=not TESTING)
# Short TTL renewed by dispatcher heartbeat; orphaned locks expire quickly after crash.
CONVERSATION_ARCHIVE_LOCK_TTL_SECONDS = env.int("CONVERSATION_ARCHIVE_LOCK_TTL_SECONDS", default=120)
CONVERSATION_ARCHIVE_LOCK_HEARTBEAT_EVERY = env.int("CONVERSATION_ARCHIVE_LOCK_HEARTBEAT_EVERY", default=100)
# Steal lock when owner batch is finished/missing or older than this (seconds).
CONVERSATION_ARCHIVE_LOCK_STALE_SECONDS = env.int("CONVERSATION_ARCHIVE_LOCK_STALE_SECONDS", default=1800)
# PENDING/IN_PROGRESS older than this are reclaimed as FAILED and re-enqueued.
CONVERSATION_ARCHIVE_STALE_RECORD_SECONDS = env.int("CONVERSATION_ARCHIVE_STALE_RECORD_SECONDS", default=3600)
CONVERSATION_ARCHIVE_BATCH_SIZE = env.int("CONVERSATION_ARCHIVE_BATCH_SIZE", default=500)
CONVERSATION_ARCHIVE_CELERY_QUEUE = env.str("CONVERSATION_ARCHIVE_CELERY_QUEUE", default="conversations-archive")
CONVERSATION_ARCHIVE_TASK_EXPIRES_SECONDS = env.int("CONVERSATION_ARCHIVE_TASK_EXPIRES_SECONDS", default=3600)
CONVERSATION_ARCHIVE_WINDOW_START_HOUR = env.int("CONVERSATION_ARCHIVE_WINDOW_START_HOUR", default=None)
CONVERSATION_ARCHIVE_WINDOW_END_HOUR = env.int("CONVERSATION_ARCHIVE_WINDOW_END_HOUR", default=None)
...
CHECK_IMPROVEMENTS_BATCHES_SOFT_TIME_LIMIT = env.int(
    "CHECK_IMPROVEMENTS_BATCHES_SOFT_TIME_LIMIT",
    default=21600,
)
CHECK_IMPROVEMENTS_BATCHES_SOFT_PERCENTAGE = env.int(
    "CHECK_IMPROVEMENTS_BATCHES_SOFT_PERCENTAGE",
    default=80,
)
