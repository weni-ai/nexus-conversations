    ...
    def storage_message(
        ...
        with get_message_table() as table:
            item = {
                # Primary Keys
                "conversation_key": conversation_key,
                # Sortable timestamp + UUID for uniqueness
                "message_timestamp": f"{sortable_timestamp}#{message_id}",
                # Attributes
                ...
                # Use sortable timestamp for consistent range queries
                "created_at": sortable_timestamp,
